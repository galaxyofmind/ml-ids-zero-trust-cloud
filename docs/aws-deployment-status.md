...
| Model Registry | `bigdata-ids-dev-rf/4`, `bigdata-ids-dev-classical/4` | RF/SVM packages `Completed` and `Approved`; v1–v3 packages `Rejected` after inference boot failures |
